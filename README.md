<div align="center">
  <!-- Red Bull Racing Inspired Header -->
...
<details>
<summary><b>📂 Click to see other notable projects</b></summary>
<br>
<table>
  <tr>
    <td><b>🔍 Face Recognition System</b></td>
    <td>Computer vision system using OpenCV for BK-AUTO Lab access control.</td>
  </tr>
  <tr>
    <td><b>🛠️ BK-Auto-Reader-Tool</b></td>
    <td>My first-year project: a fundamental CAN bus communication and OBD diagnostic tool.</td>
  </tr>
    <tr>
    <td><b>⚡ Automation Scripts</b></td>
    <td>Python-based tools (AutoLazada, AutoSIC) for optimizing repetitive workflows.</td>
  </tr>
</table>
</details>
